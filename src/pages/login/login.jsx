            ...
            <div className="cards mt-10 px-20 py-10 w-2/5 rounded-md flex flex-column">
                ...
                * indicates required field
                ...
                <div className='flex justify-between'>
                    <button onClick={() => props.myFunc1.onLoginWithGoogle(username.current.value, password.current.value)} className='my-bg-main my-light px-4  py-3 mt-3 rounded-full'>
                        Log In With Google
                    </button>
                    <button onClick={() => props.myFunc.onLogin(username.current.value, password.current.value)} className='my-bg-main my-light px-4  py-3 mt-3 rounded-full'>
                        Login
                    </button>
                </div>
            </div>
