...
export default function Menu(){
    ...
    let onGetData = async() => {
        try {
            let response = await axios.get('https://my-json-server.typicode.com/arifitantotito/jsonserver-1/products?category=0')
            let responseCategory = await axios.get('https://my-json-server.typicode.com/arifitantotito/jsonserver-1/category')
    ...
    let onFilter = async(idx) => {
        let response = await axios.get(`https://my-json-server.typicode.com/arifitantotito/jsonserver-1/products?category=${idx}`)
